...
extern inline t_u##BITS	U##BITS##_FromString_Base(t_char const* str, t_char const* base)\
{																					\
...
extern inline t_s##BITS	S##BITS##_FromString_Base(t_char const* str, t_char const* base)\
{																					\
