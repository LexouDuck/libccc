...
void*	StringArrayASCII_Reduce(t_char const* const* strarr,
...
void*	StringArrayASCII_Reduce_I(t_char const* const* strarr,
...
void*	StringArrayASCII_Fold(t_char const* const* strarr,
...
void*	StringArrayASCII_Fold_I(t_char const* const* strarr,
