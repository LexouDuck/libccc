...
t_ascii*		StringASCII_Pad(t_ascii const* str, t_ascii c, t_size size)
{
	t_ascii*	result;
	t_size	offset;
	t_size	length;
...
t_ascii*		StringASCII_Pad_L(t_ascii const* str, t_ascii c, t_size size)
{
	t_ascii*	result;
	t_size	offset;
	t_size	length;
...
t_ascii*		StringASCII_Pad_R(t_ascii const* str, t_ascii c, t_size size)
{
	t_ascii*	result;
	t_size	length;
	t_size	i;
