...
s_array(T)*	Array_Concat(T)(s_array(T) const* array1, s_array(T) const* array2)
{
	...
	if CCCERROR((array1 == NULL && array2 == NULL), ERROR_NULLPOINTER, NULL)
		return (NULL);
	if CCCERROR((array1 == NULL), ERROR_NULLPOINTER, NULL) return (Array_Duplicate(T)(array2));
	if CCCERROR((array2 == NULL), ERROR_NULLPOINTER, NULL) return (Array_Duplicate(T)(array1));
