...
inline t_bool		c_float_in_interval(t_float x, t_float start, t_float end)
{
...
inline t_f32	c_distance_f32(t_f32 x, t_f32 y)
{
	return (ABS(x - y));
}
inline t_f64	c_distance_f64(t_f64 x, t_f64 y)
{
	return (ABS(x - y));
}

inline t_u8		c_distance_u8(t_u8 x, t_u8 y)
{
	return (x - y);
}
inline t_u16	c_distance_u16(t_u16 x, t_u16 y)
{
	return (x - y);
}
inline t_u32	c_distance_u32(t_u32 x, t_u32 y)
{
	return (x - y);
}
inline t_u64	c_distance_u64(t_u64 x, t_u64 y)
{
	return (x - y);
}

inline t_s8		c_distance_s8(t_s8 x, t_s8 y)
{
	return (ABS(x - y));
}
inline t_s16	c_distance_s16(t_s16 x, t_s16 y)
{
	return (ABS(x - y));
}
inline t_s32	c_distance_s32(t_s32 x, t_s32 y)
{
	return (ABS(x - y));
}
inline t_s64	c_distance_s64(t_s64 x, t_s64 y)
{
	return (ABS(x - y));
}

inline t_float	c_distance_float(t_float x, t_float y)
{
	return (ABS(x - y));
}
inline t_uint	c_distance_uint(t_uint x, t_uint y)
{
	return (x - y);
}
...
*/
inline t_float	c_to_affine(t_float value_01, t_float start, t_float end)
{
...
*/
inline t_float	c_from_affine(t_float value_affine, t_float start, t_float end)
{
