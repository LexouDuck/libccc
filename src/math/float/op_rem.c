...
_INLINE() t_f80	F80_RemQuo(t_f80 a, t_f80 b, t_sint* quotient)	{ return (__builtin_remquol(a, b, quotient)); }
#endif
#if LIBCONFIG_USE_FLOAT128
_INLINE() t_f128	F128_RemQuo(t_f128 a, t_f128 b, t_sint* quotient)	{ return (__builtin_remquol(a, b, quotient)); }
#endif
#else
