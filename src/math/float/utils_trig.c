...
int __rem_pi2_f32(float x, double *y)
{
	static const double
...
int __rem_pi2_f64(double x, double *y)
{
	static const double
...
int __rem_pi2_f80(long double x, long double *y)
{
	static const long double toint = 1.5 / F80_EPSILON;
	static const double
...
int __rem_pi2_f128(long double x, long double *y)
{
	static const long double toint = 1.5 / F128_EPSILON;
	static const long double
