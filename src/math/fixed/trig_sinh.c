...
#define DEFINEFUNC_FIXED_SINH(BITS) \
t_q##BITS	Q##BITS##_SinH(t_q##BITS x) \
{ \
	if CCCERROR((Q##BITS##_IsNaN(x)), ERROR_NANARGUMENT, NULL) \
		return (Q##BITS##_ERROR); \
	return (Q##BITS##_FromF64(F64_SinH(F64_FromQ##BITS(x)))); \
} \

DEFINEFUNC_FIXED_SINH(8)
DEFINEFUNC_FIXED_SINH(16)
DEFINEFUNC_FIXED_SINH(32)
DEFINEFUNC_FIXED_SINH(64)
#if LIBCONFIG_USE_INT128
DEFINEFUNC_FIXED_SINH(128)
#endif
