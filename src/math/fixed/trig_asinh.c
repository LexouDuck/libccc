...
#define DEFINEFUNC_FIXED_INVSINH(BITS) \
t_q##BITS	Q##BITS##_InvSinH(t_q##BITS x) \
{ \
	if CCCERROR((Q##BITS##_IsNaN(x)), ERROR_NANARGUMENT, NULL) \
		return (Q##BITS##_ERROR); \
	return (Q##BITS##_FromF64(F64_InvSinH(F64_FromQ##BITS(x)))); \
} \

DEFINEFUNC_FIXED_INVSINH(8)
DEFINEFUNC_FIXED_INVSINH(16)
DEFINEFUNC_FIXED_INVSINH(32)
DEFINEFUNC_FIXED_INVSINH(64)
#if LIBCONFIG_USE_INT128
DEFINEFUNC_FIXED_INVSINH(128)
#endif
