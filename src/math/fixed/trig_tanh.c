...
#define DEFINEFUNC_FIXED_TANH(BITS) \
t_q##BITS	Q##BITS##_TanH(t_q##BITS x) \
{ \
	if CCCERROR((Q##BITS##_IsNaN(x)), ERROR_NANARGUMENT, NULL) \
		return (Q##BITS##_ERROR); \
	return (Q##BITS##_FromF64(F64_TanH(F64_FromQ##BITS(x)))); \
} \

DEFINEFUNC_FIXED_TANH(8)
DEFINEFUNC_FIXED_TANH(16)
DEFINEFUNC_FIXED_TANH(32)
DEFINEFUNC_FIXED_TANH(64)
#if LIBCONFIG_USE_INT128
DEFINEFUNC_FIXED_TANH(128)
#endif
