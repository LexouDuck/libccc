...
//!@}
	...
	#define TYPEDEF_ALIAS(TYPE, NAME, KIND) \
		...
		#define LIBCONFIG_TYPENAME_ASYNCTIME	asynctime
		#define LIBCONFIG_TYPENAME_ASYNCLOOP	asyncloop
		#define LIBCONFIG_TYPENAME_ASYNCRUN	asyncrun
		#define LIBCONFIG_TYPENAME_ASYNCHANDLE_KIND	asynchandle_kind
		#define LIBCONFIG_TYPENAME_ASYNCHANDLE	asynchandle
		#define LIBCONFIG_TYPENAME_ASYNC_TIMER	async_timer
		#define LIBCONFIG_TYPENAME_ASYNC_TIMER_FUNCTION	async_timer_function
		#define LIBCONFIG_TYPENAME_ASYNC_IDLE	async_idle
		#define LIBCONFIG_TYPENAME_ASYNC_IDLE_FUNCTION	async_idle_function
		#define LIBCONFIG_TYPENAME_ASYNC_EVENT	async_event
		#define LIBCONFIG_TYPENAME_ASYNC_EVENT_FUNCTION	async_event_function
		#define LIBCONFIG_TYPENAME_ASYNCPOLL_EVENTS	asyncpoll_events
		#define LIBCONFIG_TYPENAME_ASYNC_POLL	async_poll
		#define LIBCONFIG_TYPENAME_ASYNC_POLL_FUNCTION	async_poll_function
		#define LIBCONFIG_TYPENAME_ASYNC_WORK	async_work
		#define LIBCONFIG_TYPENAME_ASYNC_WORK_FUNCTION	async_work_function
		#define LIBCONFIG_TYPENAME_THREAD		thread
		#define LIBCONFIG_TYPENAME_THREAD_FUNCTION	thread_function
		#define LIBCONFIG_TYPENAME_MUTEX		mutex
		#define LIBCONFIG_TYPENAME_COND			condition
		#define LIBCONFIG_TYPENAME_RWLOCK		rwlock
		...
		#define LIBCONFIG_TYPENAME_TIME_MONTH	month
		#define LIBCONFIG_TYPENAME_ASYNCTIME	asynctime
		#define LIBCONFIG_TYPENAME_ASYNCLOOP	loop
		#define LIBCONFIG_TYPENAME_ASYNCRUN	runmode
		#define LIBCONFIG_TYPENAME_ASYNCHANDLE_KIND	handle_kind
		#define LIBCONFIG_TYPENAME_ASYNCHANDLE	handle
		#define LIBCONFIG_TYPENAME_ASYNC_TIMER	timer
		#define LIBCONFIG_TYPENAME_ASYNC_TIMER_FUNCTION	timer_fn
		#define LIBCONFIG_TYPENAME_ASYNC_IDLE	idle
		#define LIBCONFIG_TYPENAME_ASYNC_IDLE_FUNCTION	idle_fn
		#define LIBCONFIG_TYPENAME_ASYNC_EVENT	event
		#define LIBCONFIG_TYPENAME_ASYNC_EVENT_FUNCTION	event_fn
		#define LIBCONFIG_TYPENAME_ASYNCPOLL_EVENTS	poll_events
		#define LIBCONFIG_TYPENAME_ASYNC_POLL	poll
		#define LIBCONFIG_TYPENAME_ASYNC_POLL_FUNCTION	poll_fn
		#define LIBCONFIG_TYPENAME_ASYNC_WORK	work
		#define LIBCONFIG_TYPENAME_ASYNC_WORK_FUNCTION	work_fn
		#define LIBCONFIG_TYPENAME_THREAD		thrd
		#define LIBCONFIG_TYPENAME_THREAD_FUNCTION	thrd_fn
		#define LIBCONFIG_TYPENAME_MUTEX		mtx
		#define LIBCONFIG_TYPENAME_COND			cnd
		#define LIBCONFIG_TYPENAME_RWLOCK		rwlock
		...
		#define LIBCONFIG_TYPENAME_ASYNCTIME	AsyncTime
		#define LIBCONFIG_TYPENAME_ASYNCLOOP	AsyncLoop
		#define LIBCONFIG_TYPENAME_ASYNCRUN	AsyncRunMode
		#define LIBCONFIG_TYPENAME_ASYNCHANDLE_KIND	AsyncHandleKind
		#define LIBCONFIG_TYPENAME_ASYNCHANDLE	AsyncHandle
		#define LIBCONFIG_TYPENAME_ASYNC_TIMER	AsyncTimer
		#define LIBCONFIG_TYPENAME_ASYNC_TIMER_FUNCTION	AsyncTimerFunction
		#define LIBCONFIG_TYPENAME_ASYNC_IDLE	AsyncIdle
		#define LIBCONFIG_TYPENAME_ASYNC_IDLE_FUNCTION	AsyncIdleFunction
		#define LIBCONFIG_TYPENAME_ASYNC_EVENT	AsyncEvent
		#define LIBCONFIG_TYPENAME_ASYNC_EVENT_FUNCTION	AsyncEventFunction
		#define LIBCONFIG_TYPENAME_ASYNCPOLL_EVENTS	AsyncPollEvents
		#define LIBCONFIG_TYPENAME_ASYNC_POLL	AsyncPoll
		#define LIBCONFIG_TYPENAME_ASYNC_POLL_FUNCTION	AsyncPollFunction
		#define LIBCONFIG_TYPENAME_ASYNC_WORK	AsyncWork
		#define LIBCONFIG_TYPENAME_ASYNC_WORK_FUNCTION	AsyncWorkFunction
		#define LIBCONFIG_TYPENAME_THREAD		Thread
		#define LIBCONFIG_TYPENAME_THREAD_FUNCTION	ThreadFunction
		#define LIBCONFIG_TYPENAME_MUTEX		Mutex
		#define LIBCONFIG_TYPENAME_COND			Condition
		#define LIBCONFIG_TYPENAME_RWLOCK		RWLock
		#define LIBCONFIG_TYPENAME_VECTOR		Vector
		...
		#define LIBCONFIG_TYPENAME_THREAD_FUNCTION	THREAD_FUNCTION
		#define LIBCONFIG_TYPENAME_MUTEX		MUTEX
		#define LIBCONFIG_TYPENAME_COND			COND
		#define LIBCONFIG_TYPENAME_RWLOCK		RWLOCK
		#define LIBCONFIG_TYPENAME_VECTOR		VECTOR
		#define LIBCONFIG_TYPENAME_VECTOR2D		VECTOR2D
		#define LIBCONFIG_TYPENAME_VECTOR3D		VECTOR3D
