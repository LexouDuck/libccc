...
int						IO_Write_Format(t_fd fd, char const* format, ...) __attribute__ ((format(gnu_printf, 2, 3)));
...
int							IO_Output_Format(char const* format, ...) __attribute__ ((format(gnu_printf, 1, 2)));
