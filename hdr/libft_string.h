...
*/
void					String_Iterate(char *str, void (*f)(char *));
...
*/
void					String_Iterate_I(char *str, void (*f)(t_size, char *));
...
*/
char*					String_Map(char const *str, char (*f)(char));
...
**	applying the function 'f' to each of its chars (with index information).
*/
char*					String_Map_I(char const *str, char (*f)(t_size, char));
