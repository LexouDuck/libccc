...
#define MATH_DEFINE_FUNCTION_F16(RETURN, NAME, CNAME)	MATH_DEFINE_FUNCTION(RETURN, 16, NAME, CNAME,l)
#define MATH_DEFINE_REALFUNCTION_F16(    NAME, CNAME)	MATH_DEFINE_REALFUNCTION(    16, NAME, CNAME,l)
#define MATH_DEFINE_OPERATOR_LOP_F16(LOP,NAME, CNAME)	MATH_DEFINE_OPERATOR_LOP(LOP,16, NAME, CNAME,l)
#define MATH_DEFINE_OPERATOR_ROP_F16(ROP,NAME, CNAME)	MATH_DEFINE_OPERATOR_ROP(ROP,16, NAME, CNAME,l)
#define MATH_DEFINE_OPERATOR_RET_F16(RET,NAME, CNAME)	MATH_DEFINE_OPERATOR_RET(RET,16, NAME, CNAME,l)
#define MATH_DEFINE_REALOPERATOR_F16(    NAME, CNAME)	MATH_DEFINE_REALOPERATOR(    16, NAME, CNAME,l)
#define MATH_DEFINE_ENDORELATION_F16(    NAME, CNAME)	MATH_DEFINE_ENDORELATION(    16, NAME, CNAME,)
#else
#define MATH_DEFINE_FUNCTION_F16(RETURN, NAME, CNAME)	
#define MATH_DEFINE_REALFUNCTION_F16(    NAME, CNAME)	
#define MATH_DEFINE_OPERATOR_LOP_F16(LOP,NAME, CNAME)	
#define MATH_DEFINE_OPERATOR_ROP_F16(ROP,NAME, CNAME)	
#define MATH_DEFINE_OPERATOR_RET_F16(RET,NAME, CNAME)	
#define MATH_DEFINE_REALOPERATOR_F16(    NAME, CNAME)	
#define MATH_DEFINE_ENDORELATION_F16(    NAME, CNAME)	
#endif
...
#define MATH_DECL_FUNCTION(RETURN, NAME, CNAME) \
	MATH_DEFINE_FUNCTION_F16 (RETURN, NAME, CNAME) \
...
#define MATH_DECL_REALFUNCTION(NAME, CNAME) \
	MATH_DEFINE_REALFUNCTION_F16 (NAME, CNAME) \
...
#define MATH_DECL_OPERATOR_LOP(LOPERAND, NAME, CNAME) \
	MATH_DEFINE_OPERATOR_LOP_F16 (LOPERAND, NAME, CNAME) \
...
#define MATH_DECL_OPERATOR_ROP(ROPERAND, NAME, CNAME) \
	MATH_DEFINE_OPERATOR_ROP_F16 (ROPERAND, NAME, CNAME) \
...
#define MATH_DECL_OPERATOR_RET(RETURN, NAME, CNAME) \
	MATH_DEFINE_OPERATOR_RET_F16 (RETURN, NAME, CNAME) \
...
#define MATH_DECL_REALOPERATOR(NAME, CNAME) \
	MATH_DEFINE_REALOPERATOR_F16 (NAME, CNAME) \
...
#define MATH_DECL_ENDORELATION(NAME, CNAME) \
	MATH_DEFINE_ENDORELATION_F16 (NAME, CNAME) \
...
#ifndef signbit
#define signbit(X) ( \
	sizeof(X) == sizeof(short)  ? (int)(bool)(AS_U16(X) & F16_SIGN_BIT_MASK) : \
...
#ifndef isnormal
#define isnormal(X)	( \
	sizeof(X) == sizeof(short)  ? ((AS_U16((t_f16)X) + ((t_u16)1 << F16_MANTISSA_BITS)) & (t_u16)-1 >> 1) >= (t_u16)1 << (F16_MANTISSA_BITS + 1) : \
