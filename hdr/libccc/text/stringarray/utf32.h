...
||  libccc/text/stringarray/utf32.h          |    __    __  ___      _____  | ||
||                                           |   / /\  / /\/ . |\   /  __|\ | ||
...
#ifndef __LIBCCC_STRINGARRAY_UTF32_H
#define __LIBCCC_STRINGARRAY_UTF32_H
/*!@group{libccc_stringarray_utf32,19,libccc/text/stringarray/utf32.h}
**
**	This header defines some useful functions for handling arrays of UTF32 strings.
*/
...
//! Type definition for an array of strings (UTF32 format)
/*!
...
*/
//!@{
typedef t_utf32**	p_wcsarr;
typedef t_utf32**	p_wcstrarr;
typedef t_utf32**	p_wcstringarray;
typedef t_utf32**	p_strarrutf32;
typedef t_utf32**	p_strarrayutf32;
typedef t_utf32**	p_stringarrayutf32;
//!@}



typedef t_utf32*	(*f_stringarray_utf32_iterate)		(t_utf32* str);
typedef t_utf32*	(*f_stringarray_utf32_iterate_i)	(t_utf32* str, t_uint i);
typedef t_utf32*	(*f_stringarray_utf32_map)			(t_utf32 const* str);
typedef t_utf32*	(*f_stringarray_utf32_map_i)		(t_utf32 const* str, t_uint i);
typedef t_bool		(*f_stringarray_utf32_filter)		(t_utf32 const* str);
typedef t_bool		(*f_stringarray_utf32_filter_i)		(t_utf32 const* str, t_uint i);
typedef void*		(*f_stringarray_utf32_reduce)		(t_utf32 const* str, void* acc);
typedef void*		(*f_stringarray_utf32_reduce_i)		(t_utf32 const* str, void* acc, t_uint i);
...
//!@{
_MALLOC()
t_utf32**				StringUTF32_Split_Char(t_utf32 const* str, t_utf32 sep);
#define c_wcssplit_char	StringUTF32_Split_Char
//!@}
...
//!@{
_MALLOC()
t_utf32**				StringUTF32_Split_Charset(t_utf32 const* str, t_utf32 const* sep_chars);
#define c_wcssplit_cset	StringUTF32_Split_Charset
//!@}
...
//!@{
_MALLOC()
t_utf32**				StringUTF32_Split_String(t_utf32 const* str, t_utf32 const* sep);
#define c_wcssplit_str	StringUTF32_Split_String
//!@}
...
//!@{
_MALLOC()
t_utf32**				StringUTF32_Divide(t_utf32 const* str, t_size n);
#define c_wcsdivide		StringUTF32_Divide
//!@}
...
*/
//!@{
t_uint					StringArrayUTF32_Length(t_utf32 const* const* strarr);
#define c_wcsarrlen		StringArrayUTF32_Length
//!@}
...
*/
//!@{
t_size					StringArrayUTF32_TotalLength(t_utf32 const* const* strarr, t_uint n);
#define c_wcsarrlens	StringArrayUTF32_TotalLength
//!@}
...
**	@returns
**	A null-terminated list of unset `t_utf32*`, of length `length`.
*/
//!@{
_MALLOC()
t_utf32**				StringArrayUTF32_New(t_uint n);
#define c_wcsarrnew		StringArrayUTF32_New
//!@}
...
//!@{
_MALLOC()
t_utf32**				StringArrayUTF32_New_C(t_uint n, t_size length, t_utf32 c);
#define c_wcsarrcnew	StringArrayUTF32_New_C
//!@}
...
*/
//!@{
t_utf32**				StringArrayUTF32_Create(t_uint n, ...);
#define c_wcsarrcreate	StringArrayUTF32_Create
//!@}
...
//!@{
_MALLOC()
t_utf32**				StringArrayUTF32_Duplicate(t_utf32 const* const* strarr);
#define c_wcsarrdup		StringArrayUTF32_Duplicate
//!@}
...
//!@{
_MALLOC()
t_utf32**				StringArrayUTF32_Sub(t_utf32 const* const* strarr, t_uint start, t_uint length);
#define c_wcsarrsub		StringArrayUTF32_Sub
//!@}
...
*/
//!@{
t_utf32**				StringArrayUTF32_Copy(t_utf32** dest, t_uint dest_i, t_utf32 const* const* src, t_uint src_i, t_uint length);
#define c_wcsarrcpy		StringArrayUTF32_Copy
//!@}
...
*/
//!@{
void					StringArrayUTF32_Free(t_utf32** strarr);
#define c_wcsarrfree	StringArrayUTF32_Free
//!@}
...
*/
//!@{
void					StringArrayUTF32_Delete(t_utf32** *a_strarr);
#define c_wcsarrdel		StringArrayUTF32_Delete
//!@}
...
*/
//!@{
t_utf32**				StringArrayUTF32_Add(t_utf32** dest, t_utf32 const* str);
#define c_wcsarradd		StringArrayUTF32_Add
//!@}
...
*/
//!@{
t_utf32**				StringArrayUTF32_Insert(t_utf32** dest, t_utf32 const* str, t_uint index);
#define c_wcsarrinsert	StringArrayUTF32_Insert
//!@}
...
*/
//!@{
t_utf32**				StringArrayUTF32_Wedge(t_utf32** dest, t_utf32 const** src, t_uint index);
#define c_wcsarrwedge	StringArrayUTF32_Wedge
//!@}
...
*/
//!@{
void					StringArrayUTF32_RemoveAt(t_utf32** strarr, t_uint index);
#define c_wcsarrdelat	StringArrayUTF32_RemoveAt
//!@}
//!@doc Like Array_RemoveAt(), but you can supply a custom `del` function
//!@{
void					StringArrayUTF32_RemoveAt_F(t_utf32** strarr, t_uint index, void (*del)(t_utf32*));
#define c_wcsarrfdelat	StringArrayUTF32_RemoveAt_F
//!@}
...
*/
//!@{
void					StringArrayUTF32_Remove(t_utf32** strarr, t_utf32 const* str);
#define c_wcsarrdelone	StringArrayUTF32_Remove
//!@}
//!@doc Like Array_Remove(), but you can supply a custom `del` function
//!@{
void					StringArrayUTF32_Remove_F(t_utf32** strarr, t_utf32 const* str, void (*del)(t_utf32*));
#define c_wcsarrfdelone	StringArrayUTF32_Remove_F
//!@}
...
*/
//!@{
void					StringArrayUTF32_RemoveAll(t_utf32** strarr, t_utf32 const* str);
#define c_wcsarrdelall	StringArrayUTF32_RemoveAll
//!@}
//!@doc Like Array_RemoveAll(), but you can supply a custom `del` function
//!@{
void					StringArrayUTF32_RemoveAll_F(t_utf32** strarr, t_utf32 const* str, void (*del)(t_utf32*));
#define c_wcsarrfdelall	StringArrayUTF32_RemoveAll_F
//!@}
...
//!@{
_MALLOC()
t_utf32**				StringArrayUTF32_Replace(t_utf32 const* const* strarr, t_utf32 const* str_old, t_utf32 const* str_new);
#define c_wcsarrrep		StringArrayUTF32_Replace
//!@}
...
//!@{
_MALLOC()
t_utf32**					StringArrayUTF32_ReplaceFirst(t_utf32 const* const* strarr, t_utf32 const* str_old, t_utf32 const* str_new, t_uint n);
#define c_wcsarrrepfirst	StringArrayUTF32_ReplaceFirst
//!@}
...
//!@{
_MALLOC()
t_utf32**					StringArrayUTF32_ReplaceLast(t_utf32 const* const* strarr, t_utf32 const* str_old, t_utf32 const* str_new, t_uint n);
#define c_wcsarrreplast		StringArrayUTF32_ReplaceLast
//!@}
...
//!@{
_MALLOC()
t_utf32**				StringArrayUTF32_Reverse(t_utf32 const* const* strarr);
#define c_wcsarrrev		StringArrayUTF32_Reverse
//!@}
...
//!@{
_MALLOC()
t_utf32**				StringArrayUTF32_Pad_L(t_utf32 const* const* strarr, t_utf32 c, t_uint n);
#define c_wcsarrpadl	StringArrayUTF32_Pad_L
//!@}
...
//!@{
_MALLOC()
t_utf32**					StringArrayUTF32_Concat(t_utf32 const* const* strarr1, t_utf32 const* const* strarr2);
#define c_wcsarrconcat		StringArrayUTF32_Concat
//!@}
...
//!@{
_MALLOC()
t_utf32**					StringArrayUTF32_Append(t_utf32** *a_dest, t_utf32 const* const* src);
#define c_wcsarrappend		StringArrayUTF32_Append
//!@}
...
//!@{
_MALLOC()
t_utf32**					StringArrayUTF32_Prepend(t_utf32 const* const* src, t_utf32** *a_dest);
#define c_wcsarrprepend		StringArrayUTF32_Prepend
//!@}
...
//!@{
_MALLOC()
t_utf32**					StringArrayUTF32_Merge(t_utf32** *a_strarr1, t_utf32** *a_strarr2);
#define c_wcsarrmerge		StringArrayUTF32_Merge
//!@}
...
//!@{
_MALLOC()
t_utf32**					StringArrayUTF32_Join(t_utf32 const* const* * strarrs, t_utf32 const* const* sep);
#define c_wcsarrjoin		StringArrayUTF32_Join
//!@}
...
*/
//!@{
t_bool					StringArrayUTF32_Equals(t_utf32 const* const* strarr1, t_utf32 const* const* strarr2);
#define c_wcsarrequ		StringArrayUTF32_Equals
//!@}
...
*/
//!@{
t_bool					StringArrayUTF32_Equals_N(t_utf32 const* const* strarr1, t_utf32 const* const* strarr2, t_uint n);
#define c_wcsarrnequ	StringArrayUTF32_Equals_N
//!@}
...
*/
t_sint					StringArrayUTF32_Compare	(t_utf32 const* const* strarr1, t_utf32 const* const* strarr2, t_sint (*compare)(t_utf32 const* str1, t_utf32 const* str2));
#define c_wcsarrcmp		StringArrayUTF32_Compare
...
**	The first non-zero value returned by the `compare` function given.
*/
t_sint					StringArrayUTF32_Compare_N	(t_utf32 const* const* strarr1, t_utf32 const* const* strarr2, t_sint (*compare)(t_utf32 const* str1, t_utf32 const* str2), t_uint n);
#define c_wcsarrncmp	StringArrayUTF32_Compare_N
...
*/
//!@{
t_utf32* const*			StringArrayUTF32_Find(t_utf32* const* strarr, t_utf32 const* str);
#define c_wcsarrfind	StringArrayUTF32_Find
//!@}
...
*/
//!@{
t_utf32* const*			StringArrayUTF32_Find_F(t_utf32* const* strarr, t_bool (*match)(t_utf32 const* str));
#define c_wcsarrffind	StringArrayUTF32_Find_F
//!@}
...
*/
//!@{
t_sint					StringArrayUTF32_IndexOf(t_utf32 const* const* strarr, t_utf32 const* str);
#define c_wcsarrfindi	StringArrayUTF32_IndexOf
//!@}
...
*/
//!@{
t_sint					StringArrayUTF32_IndexOf_F(t_utf32 const* const* strarr, t_bool (*match)(t_utf32 const* str));
#define c_wcsarrffindi	StringArrayUTF32_IndexOf_F
//!@}
...
**	`strarr`, counting the total amount of occurrences of the UTF-32 character
...
*/
//!@{
t_uint						StringArrayUTF32_Count_Char(t_utf32 const* const* strarr, t_utf32 const c);
#define c_wcsarrcount_char	StringArrayUTF32_Count_Char
//!@}
...
*/
//!@{
t_uint						StringArrayUTF32_Count_Charset(t_utf32 const* const* strarr, t_utf32 const* cset);
#define c_wcsarrcount_cset	StringArrayUTF32_Count_Charset
//!@}
...
*/
//!@{
t_uint						StringArrayUTF32_Count_String(t_utf32 const* const* strarr, t_utf32 const* query);
#define c_wcsarrcount_str	StringArrayUTF32_Count_String
//!@}



// TODO StringArrayUTF32_Has()
// TODO StringArrayUTF32_HasOnly()
...
*/
//!@{
void					StringArrayUTF32_Iterate(t_utf32** strarr, t_utf32* (*f)(t_utf32* str));
#define c_wcsarriter	StringArrayUTF32_Iterate
//!@}
//!@doc Like StringArrayUTF32_Iterate(), but the user-supplied function receives the current index
//!@{
void					StringArrayUTF32_Iterate_I(t_utf32** strarr, t_utf32* (*f)(t_utf32* str, t_uint index));
#define c_wcsarriiter	StringArrayUTF32_Iterate_I
//!@}
...
//!@{
_MALLOC()
t_utf32**				StringArrayUTF32_Map(t_utf32 const* const* strarr, t_utf32* (*map)(t_utf32 const* str));
#define c_wcsarrmap		StringArrayUTF32_Map
//!@}
//!@doc Like StringArrayUTF32_Map(), but the user-supplied function receives the current index
//!@{
t_utf32**				StringArrayUTF32_Map_I(t_utf32 const* const* strarr, t_utf32* (*map)(t_utf32 const* str, t_uint index));
#define c_wcsarrimap	StringArrayUTF32_Map_I
//!@}
...
*/
//!@{
t_utf32**				StringArrayUTF32_Filter(t_utf32 const* const* strarr, t_bool (*filter)(t_utf32 const* str));
#define c_wcsarrfilter	StringArrayUTF32_Filter
//!@}
//!@doc Like StringArrayUTF32_Filter(), but the user-supplied function receives the current index
//!@{
t_utf32**				StringArrayUTF32_Filter_I(t_utf32 const* const* strarr, t_bool (*filter)(t_utf32 const* str, t_uint index));
#define c_wcsarrifilter	StringArrayUTF32_Filter_I
//!@}
...
/*!
**	The difference between StringArrayUTF32_Reduce() and StringArrayUTF32_Fold() is that with this function,
...
*/
//!@{
void*					StringArrayUTF32_Reduce(t_utf32 const* const* strarr, void* (*f)(t_utf32 const* str, void* acc));
#define c_wcsarrreduce	StringArrayUTF32_Reduce
//!@}
//!@doc Like StringArrayUTF32_Reduce(), but the user-supplied function receives the current index
//!@{
void*					StringArrayUTF32_Reduce_I(t_utf32 const* const* strarr, void* (*f)(t_utf32 const* str, void* acc, t_uint index));
#define c_wcsarrireduce	StringArrayUTF32_Reduce_I
//!@}

//!@doc Creates a single value by executing the given function `f` for each string of the given string array `strarr`.
/*!
**	The difference between StringArrayUTF32_Fold() and StringArrayUTF32_Reduce() is that with this function,
...
*/
//!@{
void*					StringArrayUTF32_Fold(t_utf32 const* const* strarr, void* (*f)(t_utf32 const* str, void* acc), void* initial);
#define c_wcsarrfold	StringArrayUTF32_Fold
//!@}
//!@doc Like StringArrayUTF32_Reduce(), but the user-supplied function receives the current index
//!@{
void*					StringArrayUTF32_Fold_I(t_utf32 const* const* strarr, void* (*f)(t_utf32 const* str, void* acc, t_uint index), void* initial);
#define c_wcsarrifold	StringArrayUTF32_Fold_I
//!@}
