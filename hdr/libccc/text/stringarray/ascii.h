...
||  libccc/text/stringarray/ascii.h          |    __    __  ___      _____  | ||
||                                           |   / /\  / /\/ . |\   /  __|\ | ||
...
#ifndef __LIBCCC_STRINGARRAY_ASCII_H
#define __LIBCCC_STRINGARRAY_ASCII_H
/*!@group{libccc_stringarray_ascii,19,libccc/text/stringarray/ascii.h}
**
**	This header defines some useful functions for handling arrays of ASCII strings.
*/
...
*/
//!@{
typedef t_ascii**	p_strarrascii;
typedef t_ascii**	p_strarrayascii;
typedef t_ascii**	p_stringarrayascii;
//!@}



typedef t_ascii*	(*f_stringarray_ascii_iterate)		(t_ascii* str);
typedef t_ascii*	(*f_stringarray_ascii_iterate_i)	(t_ascii* str, t_uint i);
typedef t_ascii*	(*f_stringarray_ascii_map)			(t_ascii const* str);
typedef t_ascii*	(*f_stringarray_ascii_map_i)		(t_ascii const* str, t_uint i);
typedef t_bool		(*f_stringarray_ascii_filter)		(t_ascii const* str);
typedef t_bool		(*f_stringarray_ascii_filter_i)		(t_ascii const* str, t_uint i);
typedef void*		(*f_stringarray_ascii_reduce)		(t_ascii const* str, void* acc);
typedef void*		(*f_stringarray_ascii_reduce_i)		(t_ascii const* str, void* acc, t_uint i);
...
//!@{
_MALLOC()
t_ascii**				StringASCII_Split_Char(t_ascii const* str, t_ascii sep);
#define c_strsplit_char	StringASCII_Split_Char
//!@}
...
//!@{
_MALLOC()
t_ascii**				StringASCII_Split_Charset(t_ascii const* str, t_ascii const* sep_chars);
#define c_strsplit_cset	StringASCII_Split_Charset
//!@}
...
//!@{
_MALLOC()
t_ascii**				StringASCII_Split_String(t_ascii const* str, t_ascii const* sep);
#define c_strsplit_str	StringASCII_Split_String
//!@}
...
//!@{
_MALLOC()
t_ascii**				StringASCII_Divide(t_ascii const* str, t_size n);
#define c_strdivide		StringASCII_Divide
//!@}
...
*/
//!@{
t_uint					StringArrayASCII_Length(t_ascii const* const* strarr);
#define c_strarrlen		StringArrayASCII_Length
//!@}
...
*/
//!@{
t_size					StringArrayASCII_TotalLength(t_ascii const* const* strarr, t_uint n);
#define c_strarrlens	StringArrayASCII_TotalLength
//!@}
...
**	@returns
**	A null-terminated list of unset `t_ascii*`, of length `length`.
*/
//!@{
_MALLOC()
t_ascii**				StringArrayASCII_New(t_uint n);
#define c_strarrnew		StringArrayASCII_New
//!@}
...
//!@{
_MALLOC()
t_ascii**				StringArrayASCII_New_C(t_uint n, t_size length, t_ascii c);
#define c_strarrcnew	StringArrayASCII_New_C
//!@}
...
*/
//!@{
t_ascii**				StringArrayASCII_Create(t_uint n, ...);
#define c_strarrcreate	StringArrayASCII_Create
//!@}
...
//!@{
_MALLOC()
t_ascii**				StringArrayASCII_Duplicate(t_ascii const* const* strarr);
#define c_strarrdup		StringArrayASCII_Duplicate
//!@}
...
//!@{
_MALLOC()
t_ascii**				StringArrayASCII_Sub(t_ascii const* const* strarr, t_uint start, t_uint length);
#define c_strarrsub		StringArrayASCII_Sub
//!@}
...
*/
//!@{
t_ascii**				StringArrayASCII_Copy(t_ascii** dest, t_uint dest_i, t_ascii const* const* src, t_uint src_i, t_uint length);
#define c_strarrcpy		StringArrayASCII_Copy
//!@}
...
*/
//!@{
void					StringArrayASCII_Free(t_ascii** strarr);
#define c_strarrfree	StringArrayASCII_Free
//!@}
...
*/
//!@{
void					StringArrayASCII_Delete(t_ascii** *a_strarr);
#define c_strarrdel		StringArrayASCII_Delete
//!@}
...
*/
//!@{
t_ascii**				StringArrayASCII_Add(t_ascii** dest, t_ascii const* str);
#define c_strarradd		StringArrayASCII_Add
//!@}
...
*/
//!@{
t_ascii**				StringArrayASCII_Insert(t_ascii** dest, t_ascii const* str, t_uint index);
#define c_strarrinsert	StringArrayASCII_Insert
//!@}
...
*/
//!@{
t_ascii**				StringArrayASCII_Wedge(t_ascii** dest, t_ascii const** src, t_uint index);
#define c_strarrwedge	StringArrayASCII_Wedge
//!@}
...
*/
//!@{
void					StringArrayASCII_RemoveAt(t_ascii** strarr, t_uint index);
#define c_strarrdelat	StringArrayASCII_RemoveAt
//!@}
//!@doc Like Array_RemoveAt(), but you can supply a custom `del` function
//!@{
void					StringArrayASCII_RemoveAt_F(t_ascii** strarr, t_uint index, void (*del)(t_ascii*));
#define c_strarrfdelat	StringArrayASCII_RemoveAt_F
//!@}
...
*/
//!@{
void					StringArrayASCII_Remove(t_ascii** strarr, t_ascii const* str);
#define c_strarrdelone	StringArrayASCII_Remove
//!@}
//!@doc Like Array_Remove(), but you can supply a custom `del` function
//!@{
void					StringArrayASCII_Remove_F(t_ascii** strarr, t_ascii const* str, void (*del)(t_ascii*));
#define c_strarrfdelone	StringArrayASCII_Remove_F
//!@}
...
*/
//!@{
void					StringArrayASCII_RemoveAll(t_ascii** strarr, t_ascii const* str);
#define c_strarrdelall	StringArrayASCII_RemoveAll
//!@}
//!@doc Like Array_RemoveAll(), but you can supply a custom `del` function
//!@{
void					StringArrayASCII_RemoveAll_F(t_ascii** strarr, t_ascii const* str, void (*del)(t_ascii*));
#define c_strarrfdelall	StringArrayASCII_RemoveAll_F
//!@}
...
//!@{
_MALLOC()
t_ascii**				StringArrayASCII_Replace(t_ascii const* const* strarr, t_ascii const* str_old, t_ascii const* str_new);
#define c_strarrrep		StringArrayASCII_Replace
//!@}
...
//!@{
_MALLOC()
t_ascii**					StringArrayASCII_ReplaceFirst(t_ascii const* const* strarr, t_ascii const* str_old, t_ascii const* str_new, t_uint n);
#define c_strarrrepfirst	StringArrayASCII_ReplaceFirst
//!@}
...
//!@{
_MALLOC()
t_ascii**					StringArrayASCII_ReplaceLast(t_ascii const* const* strarr, t_ascii const* str_old, t_ascii const* str_new, t_uint n);
#define c_strarrreplast		StringArrayASCII_ReplaceLast
//!@}
...
//!@{
_MALLOC()
t_ascii**				StringArrayASCII_Reverse(t_ascii const* const* strarr);
#define c_strarrrev		StringArrayASCII_Reverse
//!@}
...
//!@{
_MALLOC()
t_ascii**				StringArrayASCII_Pad_L(t_ascii const* const* strarr, t_ascii c, t_uint n);
#define c_strarrpadl	StringArrayASCII_Pad_L
//!@}
...
//!@{
_MALLOC()
t_ascii**					StringArrayASCII_Concat(t_ascii const* const* strarr1, t_ascii const* const* strarr2);
#define c_strarrconcat		StringArrayASCII_Concat
//!@}
...
//!@{
_MALLOC()
t_ascii**					StringArrayASCII_Append(t_ascii** *a_dest, t_ascii const* const* src);
#define c_strarrappend		StringArrayASCII_Append
//!@}
...
//!@{
_MALLOC()
t_ascii**					StringArrayASCII_Prepend(t_ascii const* const* src, t_ascii** *a_dest);
#define c_strarrprepend		StringArrayASCII_Prepend
//!@}
...
//!@{
_MALLOC()
t_ascii**					StringArrayASCII_Merge(t_ascii** *a_strarr1, t_ascii** *a_strarr2);
#define c_strarrmerge		StringArrayASCII_Merge
//!@}
...
//!@{
_MALLOC()
t_ascii**					StringArrayASCII_Join(t_ascii const* const* * strarrs, t_ascii const* const* sep);
#define c_strarrjoin		StringArrayASCII_Join
//!@}
...
*/
//!@{
t_bool					StringArrayASCII_Equals(t_ascii const* const* strarr1, t_ascii const* const* strarr2);
#define c_strarrequ		StringArrayASCII_Equals
//!@}
...
*/
//!@{
t_bool					StringArrayASCII_Equals_N(t_ascii const* const* strarr1, t_ascii const* const* strarr2, t_uint n);
#define c_strarrnequ	StringArrayASCII_Equals_N
//!@}
...
*/
t_sint					StringArrayASCII_Compare	(t_ascii const* const* strarr1, t_ascii const* const* strarr2, t_sint (*compare)(t_ascii const* str1, t_ascii const* str2));
#define c_strarrcmp		StringArrayASCII_Compare
...
**	The first non-zero value returned by the `compare` function given.
*/
t_sint					StringArrayASCII_Compare_N	(t_ascii const* const* strarr1, t_ascii const* const* strarr2, t_sint (*compare)(t_ascii const* str1, t_ascii const* str2), t_uint n);
#define c_strarrncmp	StringArrayASCII_Compare_N
...
*/
//!@{
t_ascii* const*			StringArrayASCII_Find(t_ascii* const* strarr, t_ascii const* str);
#define c_strarrfind	StringArrayASCII_Find
//!@}
...
*/
//!@{
t_ascii* const*			StringArrayASCII_Find_F(t_ascii* const* strarr, t_bool (*match)(t_ascii const* str));
#define c_strarrffind	StringArrayASCII_Find_F
//!@}
...
*/
//!@{
t_sint					StringArrayASCII_IndexOf(t_ascii const* const* strarr, t_ascii const* str);
#define c_strarrfindi	StringArrayASCII_IndexOf
//!@}
...
*/
//!@{
t_sint					StringArrayASCII_IndexOf_F(t_ascii const* const* strarr, t_bool (*match)(t_ascii const* str));
#define c_strarrffindi	StringArrayASCII_IndexOf_F
//!@}
...
#define c_strarrcount_char	StringArrayASCII_Count_Char
//!@}
...
#define c_strarrcount_cset	StringArrayASCII_Count_Charset
//!@}
...
#define c_strarrcount_str	StringArrayASCII_Count_String
//!@}



// TODO StringArrayASCII_Has()
// TODO StringArrayASCII_HasOnly()
...
*/
//!@{
void					StringArrayASCII_Iterate(t_ascii** strarr, t_ascii* (*f)(t_ascii* str));
#define c_strarriter	StringArrayASCII_Iterate
//!@}
//!@doc Like StringArrayASCII_Iterate(), but the user-supplied function receives the current index
//!@{
void					StringArrayASCII_Iterate_I(t_ascii** strarr, t_ascii* (*f)(t_ascii* str, t_uint index));
#define c_strarriiter	StringArrayASCII_Iterate_I
//!@}
...
//!@{
_MALLOC()
t_ascii**				StringArrayASCII_Map(t_ascii const* const* strarr, t_ascii* (*map)(t_ascii const* str));
#define c_strarrmap		StringArrayASCII_Map
//!@}
//!@doc Like StringArrayASCII_Map(), but the user-supplied function receives the current index
//!@{
t_ascii**				StringArrayASCII_Map_I(t_ascii const* const* strarr, t_ascii* (*map)(t_ascii const* str, t_uint index));
#define c_strarrimap	StringArrayASCII_Map_I
//!@}
...
*/
//!@{
t_ascii**				StringArrayASCII_Filter(t_ascii const* const* strarr, t_bool (*filter)(t_ascii const* str));
#define c_strarrfilter	StringArrayASCII_Filter
//!@}
//!@doc Like StringArrayASCII_Filter(), but the user-supplied function receives the current index
//!@{
t_ascii**				StringArrayASCII_Filter_I(t_ascii const* const* strarr, t_bool (*filter)(t_ascii const* str, t_uint index));
#define c_strarrifilter	StringArrayASCII_Filter_I
//!@}
...
/*!
**	The difference between StringArrayASCII_Reduce() and StringArrayASCII_Fold() is that with this function,
...
*/
//!@{
void*					StringArrayASCII_Reduce(t_ascii const* const* strarr, void* (*reduce)(t_ascii const* str, void* acc));
#define c_strarrreduce	StringArrayASCII_Reduce
//!@}
//!@doc Like StringArrayASCII_Reduce(), but the user-supplied function receives the current index
//!@{
void*					StringArrayASCII_Reduce_I(t_ascii const* const* strarr, void* (*reduce)(t_ascii const* str, void* acc, t_uint index));
#define c_strarrireduce	StringArrayASCII_Reduce_I
//!@}

//!@doc Creates a single value by executing the given function `f` for each string of the given string array `strarr`.
/*!
**	The difference between StringArrayASCII_Fold() and StringArrayASCII_Reduce() is that with this function,
...
*/
//!@{
void*					StringArrayASCII_Fold(t_ascii const* const* strarr, void* (*fold)(t_ascii const* str, void* acc), void* initial);
#define c_strarrfold	StringArrayASCII_Fold
//!@}
//!@doc Like StringArrayASCII_Reduce(), but the user-supplied function receives the current index
//!@{
void*					StringArrayASCII_Fold_I(t_ascii const* const* strarr, void* (*fold)(t_ascii const* str, void* acc, t_uint index), void* initial);
#define c_strarrifold	StringArrayASCII_Fold_I
//!@}
