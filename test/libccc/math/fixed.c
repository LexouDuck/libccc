...
{ \
/*	| TEST FUNCTION             | TEST NAME         |TESTFLAG| TEST */ \
	print_test_q##BITS##FUNCNAME("q"#BITS#FUNCNAME" ",	FALSE,  TEST(BITS, FUNCNAME, QV(BITS, Q##BITS##_DENOM), QV(BITS, Q##BITS##_DENOM)) ); \
	print_test_q##BITS##FUNCNAME("q"#BITS#FUNCNAME" ",	FALSE,  TEST(BITS, FUNCNAME, QV(BITS, Q##BITS##_DENOM * 2), QV(BITS, Q##BITS##_DENOM)) ); \
