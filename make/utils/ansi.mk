...
#{
IO_RESET        := $(call ANSI,0)
IO_RED          := $(call ANSI,0;31)
IO_GREEN        := $(call ANSI,0;32)
IO_YELLOW       := $(call ANSI,0;33)
IO_BLUE         := $(call ANSI,0;34)
IO_MAGENTA      := $(call ANSI,0;35)
IO_CYAN         := $(call ANSI,0;36)
IO_GRAY         := $(call ANSI,0;37)
IO_DARK         := $(call ANSI,0;90)
IO_LIGHTRED     := $(call ANSI,0;91)
IO_LIGHTGREEN   := $(call ANSI,0;92)
IO_LIGHTYELLOW  := $(call ANSI,0;93)
IO_LIGHTBLUE    := $(call ANSI,0;94)
IO_LIGHTMAGENTA := $(call ANSI,0;95)
IO_LIGHTCYAN    := $(call ANSI,0;96)
IO_WHITE        := $(call ANSI,0;97)
#}
